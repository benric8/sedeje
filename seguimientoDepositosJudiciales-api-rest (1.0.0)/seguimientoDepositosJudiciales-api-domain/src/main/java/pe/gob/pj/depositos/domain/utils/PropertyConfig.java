...
public class PropertyConfig implements Serializable {
	...
	//# RENIEC
		@Value("${configuracion.tecnica.servicio.wsreniec.endpoint:null}")
		private String endPointReniec;
		@Value("${configuracion.tecnica.servicio.wsreniec.timeout:50}")
		private Integer timeOutReniec;
		@Value("${configuracion.tecnica.servicio.wsreniec.dniconsultante:null}")
		private String dniConsultanteReniec;
		@Value("${configuracion.tecnica.servicio.wsreniec.usuario:null}")
